...
DROP TRIGGER T_ZAJEMCI_CHECK_NOVE_OPRAVNENI;
...
DROP TRIGGER T_LOG_INSERT_SOUBORY;
DROP TRIGGER T_LOG_UPDATE_SOUBORY;
DROP TRIGGER T_LOG_DELETE_SOUBORY;
-- POHLEDY
...
DROP PROCEDURE P_UPDATE_MISTNOST;
DROP PROCEDURE P_UPDATE_REZERVACI;
