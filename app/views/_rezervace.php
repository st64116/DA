...
<table class="mistnosti ms-auto me-auto text-center shadow-lg mt-3">
    ...
    if(count($viewRezervace) == 0){
        ...
        foreach ($viewRezervace as $rezervace) {
            ...
            echo "<td>" . $rezervace["Od"]  . "</td>";
            echo "<td>" . $rezervace["Do"]  . "</td>";
            echo "<td>" . $rezervace['Zajemce'] . "</td>";
            echo "<td>" . $rezervace['Mistnost'] . "</td>";
            echo "<td>" . $rezervace['Prislusenstvi'] . "</td>";
            echo "<td>" . $rezervace['Stav'] . "</td>";
            echo "</tr>";
...
<input class="d-none" type="text" name="osobaId" value="'  . $rezervace['ID'] . '">
