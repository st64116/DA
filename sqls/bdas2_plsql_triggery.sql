-- REZERVACE CHECK casy a stav s mistnosti
...
CREATE OR REPLACE TRIGGER t_zajemci_check_opravneni BEFORE
    INSERT ON zajemci
...
BEFORE
    INSERT OR UPDATE ON prislusenstvi
    REFERENCING
        NEW AS new
    FOR EACH ROW
BEGIN
...
BEFORE
    INSERT OR UPDATE ON skupiny_vlastnosti
    REFERENCING
        NEW AS new
    FOR EACH ROW
BEGIN
